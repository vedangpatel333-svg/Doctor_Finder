...
<body>
    ...
    %>
     ...
     <!--map-->
	 <form action="mailjp.jsp" name="register" id="reg" method="post">
			...
			<font color="red">${msg }</font>
				...
				<span class="input input--juro">
					...
					<label class="input__label input__label--juro" for="input-30">
						<span class="input__label-content input__label-content--juro">Enter your Email</span>
					</label>
				</span><br>
				
				
				<span class="input input--juro">
					<button class="btn btn-1 btn-1a">Click</button>
				</span>	
				<br>
